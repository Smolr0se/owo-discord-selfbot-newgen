...
class UI:
	...
	def newData(cls):
		...
		cls.slowPrinting("         [12] Change Sell Mode")
	...
	def info(cls):
		...
		cls.slowPrinting(f"\t{color.purple}https://discord.gg/9uZ6eXFPHD (This support server have suspended inviting){color.reset}")
		cls.slowPrinting(f"\t{color.purple}https://discord.gg/qSakx4K5Zw (Youzke's server - still working){color.reset}")
		cls.slowPrinting(" ")
		...
		cls.slowPrinting(f'\t{color.purple} [Developer] {color.reset} Sudo-Nizel (Main dev)')
		cls.slowPrinting(f'\t{color.purple} [Developer] {color.reset} ahihiyou20 (Main dev)')
		cls.slowPrinting(f'\t{color.purple} [Developer] {color.reset} Youzke (Leecher dev)')
		cls.slowPrinting(" ")
